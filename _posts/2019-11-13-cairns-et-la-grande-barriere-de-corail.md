...
{% include lightslider.html gallery=site.data.galleries.cairns.nuit_cairns %}
...
{% include lightslider.html gallery=site.data.galleries.cairns.van_int %}
...
Autour de nous, l'environnement est superbe. Nous découvrons de nombreux coraux et poissons de toutes les tailles, aux multiples couleurs chatoyantes, et aux 
...
- Remarque générale : chaleur humide, après Ayers Rock on le remarque
- Book plongée via l'hôtel
- Récupération van (gros stress CB)
- Prise en main du van
- Courses
- Balade côte
- Baignade piscine extérieure accès libre
- Première nuit dans le van sur parking

15/11/2019 :

- Réveillé par les arroseurs automatiques
- Go to bateau pour plongée !
- Journée de tarée : 3 plongées, de super photos, de super poissons, une giga tortue, du courant sur la dernière : dur !
- Courses
- Hésitation longue pour dormir à Cairns mais interdit<<
- Route 30 min vers le nord pour spot nuit, sur un parking non goudronné le long du plage (vue depuis le van, dur)-->